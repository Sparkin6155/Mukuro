...
TOKEN = 'NDY3ODAzODEyODY2OTQ5MTIx.Div7yQ.kkXOvedNMJhvSbRD_XDbrtjGu4w'
bot = Discordrb::Commands::CommandBot.new token: TOKEN, prefix: 'k!'

bot.ready do |event|
    bot.dnd
    bot.game = 'PokéWolf'
    puts "This is Kecleon."
end

bot.dm do |event|
    event.respond "..."
    bot.send_message(467796170656317460, "#{event.user.mention} has told me: \n#{event.message.content}")
end
...
bot.message(from: 271097183292489729, in: 467793704682389535) do |event|
